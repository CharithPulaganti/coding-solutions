...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-07T09:12:03.043Z  
...
SELECT 'There are a total of ' || CHAR(COUNT(*)) || ' ' || CASE Occupation WHEN 'Doctor' THEN 'doctor' WHEN 'Professor' THEN 'professor' WHEN 'Singer' THEN 'singer' WHEN 'Actor' THEN 'actor' END || 's.' FROM OCCUPATIONS GROUP BY Occupation ORDER BY COUNT(*), Occupation;
